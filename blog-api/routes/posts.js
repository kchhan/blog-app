...
router.post('/new', verifyToken, post_controller.post_create_post);

// GET and UPDATE blog posts (editor only)
router.get('/:id/edit', post_controller.post_update_get);
router.post('/:id/edit', verifyToken, post_controller.post_update_post);

// GET and DELETE blog post
router.get('/:id/delete', post_controller.post_delete_get);
router.post('/:id/delete', verifyToken, post_controller.post_delete_post);

// GET specfic blog post and POST comments
router.get('/:id', post_controller.post_detail_get);
router.post('/:id', verifyToken, post_controller.post_detail_post);
